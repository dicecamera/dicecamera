...
public final class MenuBar extends Layer implements PopupMenu.Listener {
    ...
    private static final int BACKGROUND = R.drawable.album_selection_menu_bg;
    private static final int SEPERATOR = R.drawable.album_selection_menu_divider;
    private static final int MENU_HIGHLIGHT_LEFT = R.drawable.album_selection_menu_bg_pressed_left;
    private static final int MENU_HIGHLIGHT_MIDDLE = R.drawable.album_selection_menu_bg_pressed;
    private static final int MENU_HIGHLIGHT_RIGHT = R.drawable.album_selection_menu_bg_pressed_right;
