...
public final class PathBarLayer extends Layer {
    ...
    private static final int FILL = R.drawable.album_pathbar_bg;
    private static final int JOIN = R.drawable.album_pathbar_join;
    private static final int CAP = R.drawable.album_pathbar_cap;
